...
class DescriptiveSelectField(SelectField):
    ...
    def __init__(
        ...
        choices=None, description='', **kwargs
    ):
...
class SurveyForm(FlaskForm):
    ...
    poorhlth = DescriptiveSelectField(
        ...
        description="During the past 30 days, for about how many days did \
    ...
    physhlth = DescriptiveSelectField(
        ...
        choices=[('', '---'), ('Yes', 'Yes'),
                 ('No', 'No'), ('Not Sure', 'Not Sure')],
        description="About your physical health, which includes physical \
    ...
    diffwalk = DescriptiveSelectField(
        ...
        choices=[('', '---'), ('Yes', 'Yes'), ('No', 'No'),
                 ('Not Sure', 'Not Sure')],
        description="Do you have serious difficulty walking \
            or climbing stairs?",
        validators=[DataRequired()]
    )
    diffalon = DescriptiveSelectField(
        ...
        choices=[('', '---'), ('Yes', 'Yes'), ('No', 'No'),
                 ('Not Sure', 'Not Sure')],
        description="Because of a physical, mental, or emotional condition, \
    ...
    checkup1 = DescriptiveSelectField(
        ...
        choices=[('', '---'), ('Yes', 'Yes'), ('No', 'No'),
                 ('Not Sure', 'Not Sure')],
        description="Describe your general health status. The quick brown \
    ...
    # Mental Health Section
    addepev3 = DescriptiveSelectField(  # ADDEPEV3
    ...
    acedeprs = DescriptiveSelectField(  # ACEDEPRS
        label='Live With Anyone Depressed, Mentally Ill, Or Suicidal?',
        choices=[('', '---'), ('Yes', 'Yes'), ('No', 'No'),
                 ('Sometimes', 'Sometimes')],
        description="Did you live with anyone who was depressed, \
    ...
    sdlonely = DescriptiveSelectField(
        ...
        choices=[('', '---'), ('Yes', 'Yes'), ('No', 'No'),
                 ('Sometimes', 'Sometimes')],
        description="How often do you feel lonely?  Is it…",
        validators=[DataRequired()]
    )
    ...
    emtsuprt = DescriptiveSelectField(
        ...
        choices=[('', '---'), ('Yes', 'Yes'), ('No', 'No'),
                 ('Sometimes', 'Sometimes')],
        description="How often do you get the social and emotional \
            support you need?",
        validators=[DataRequired()]
    )
    ...
    cdsocia1 = DescriptiveSelectField(  # CDSOCIA1
        label='Does difficulties with thinking or memory interfere with \
            work or social activities',
        choices=[('', '---'), ('Yes', 'Yes'), ('No', 'No'),
                 ('Sometimes', 'Sometimes')],
        description="During the past 12 months, have your difficulties \
    ...
    smokday2 = DescriptiveSelectField(
        ...
        description=" Do you now smoke cigarettes every day, some days, \
            or not at all?",
        validators=[DataRequired()]
    )
    alcday4 = DescriptiveSelectField(
        ...
        choices=[('', '---'), ('Daily', 'Daily'),
                 ('Occasionally', 'Occasionally'), ('Never', 'Never')],
        description="During the past 30 days, how many days per week or \
    ...
    marijan1 = DescriptiveSelectField(  # MARIJAN1
        label='During the past 30 days, on how many days did you use \
            marijuana or hashish?',
        choices=[('', '---'), ('Daily', 'Daily'),
                 ('Occasionally', 'Occasionally'), ('Never', 'Never')],
        description="During the past 30 days, on how many days did you use \
            marijuana or cannabis?",
        validators=[DataRequired()]
    )
    exeroft1 = DescriptiveSelectField(  # EXEROFT
        label='How Many Times Walking, Running, Jogging, or Swimming',
        choices=[('', '---'), ('Daily', 'Daily'),
                 ('Occasionally', 'Occasionally'), ('Never', 'Never')],
        description="How many times per week or per month did you take \
    ...
    usenow3 = DescriptiveSelectField(
        ...
        choices=[('', '---'), ('Daily', 'Daily'),
                 ('Occasionally', 'Occasionally'), ('Never', 'Never')],
        description="Do you currently use chewing tobacco, snuff, \
    ...
    educa = DescriptiveSelectField(
        ...
        choices=[('', '---'), ('High School', 'High School'),
                 ...
                 ('Doctorate', 'Doctorate')],
        description="What is the highest grade or year of school you \
            completed?",
        validators=[DataRequired()]
    )
    ...
    sdhbills = DescriptiveSelectField(
        ...
        choices=[('', '---'), ('Yes', 'Yes'), ('No', 'No')],
        description="During the last 12 months, was there a time when you \
    ...
    sdhemple = DescriptiveSelectField(
        ...
        choices=[('', '---'), ('Yes', 'Yes'), ('No', 'No')],
        description="In the past 12 months have you lost employment or \
            had hours reduced?",
        validators=[DataRequired()]
    )
    ...
    sdhstre1 = DescriptiveSelectField(
        ...
        choices=[('', '---'), ('Yes', 'Yes'), ('No', 'No')],
        description="Within the last 30 days, how often have you felt \
            this kind of stress?",
        validators=[DataRequired()]
    )
    sdhutils = DescriptiveSelectField(  # SDHUTILS
        label='Were you not able to pay utility bills or threatened \
            to lose service?',
        choices=[('', '---'), ('Yes', 'Yes'), ('No', 'No')],
    ...
    hvarth4 = DescriptiveSelectField(
        ...
        choices=[('', '---'), ('Yes', 'Yes'), ('No', 'No')],
        description="(Ever told) (you had) some form of arthritis, \
    ...
    diabete4 = DescriptiveSelectField(
        ...
        choices=[('', '---'), ('Yes', 'Yes'), ('No', 'No')],
        description="(Ever told) (you had) diabetes?  (If ´Yes´ and \
    ...
    cholchk3 = DescriptiveSelectField(  # cholchk3
        label='How Long since Cholesterol Checked',
        choices=[('', '---'), ('Yes', 'Yes'), ('No', 'No')],
        description="About how long has it been since you last had \
            your cholesterol checked?",
        validators=[DataRequired()]
    )
    bpmeds1 = DescriptiveSelectField(  # BPMEDS1
        label='Currently Taking Prescription Blood Pressure Medication',
        choices=[('', '---'), ('Yes', 'Yes'), ('No', 'No')],
        description="Are you currently taking prescription medicine \
    ...
    cvdcrhd4 = DescriptiveSelectField(  # CVDCRHD4
